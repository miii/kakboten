...
<div id="footer" class="tutorial">
    <img src="images/v3/html5_logo.png" alt="HTML5" title="Den här webbplatsen är uppbyggd med hjälp av HTML5" />
    <div id="copyright">
...
$(document).ready(function() {
	...
	function oldSite() { document.location.href = 'http://old.kakboten.se/'; }
	...
	function resizeContent() {
		...
		// If screen width is less than 1158px, hide the history wrapper
		if ($('body').width() < 1158) $('.historyWrapper, h3').hide();
